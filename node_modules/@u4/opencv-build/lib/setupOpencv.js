...
class SetupOpencv {
    ...
    getSharedCmakeFlags() {
        ...
        if (this.builder.env.buildWithCuda && (0, utils_js_1.isCudaAvailable)()) {
    ...
    async start() {
        ...
        try {
            for (const k of BuildEnv_js_1.OPENCV_PATHS_ENV) {
            ...
            if (env.isWithoutContrib) {
                ...
                npmlog_1.default.info('install', `git clone ${this.builder.constant.opencvContribRepoUrl}`);
            ...
            npmlog_1.default.info('install', `git clone ${this.builder.constant.opencvRepoUrl}`);

...
const BuildEnv_js_1 = require("./BuildEnv.js");
// import { fileURLToPath } from 'url';
// import { dirname } from 'path';
class OpenCVBuilder {
    constructor(opts) {
        if (Array.isArray(opts)) {
            opts = (0, BuildEnv_js_1.args2Option)(opts);
            if (opts.extra && (opts.extra.help || opts.extra.h)) {
                console.log('npm-opencv-build usage:');
                console.log((0, BuildEnv_js_1.genHelp)());
                process.exit(1);
            }
        }
        if (opts instanceof BuildEnv_js_1.OpenCVBuildEnv) {
            this.env = opts;
        }
        else {
            this.env = new BuildEnv_js_1.OpenCVBuildEnv(opts);
        }
    ...
    async install() {
        ...
        npmlog_1.default.info('install', `if you want to use an own OpenCV build set ${utils.highlight('OPENCV4NODEJS_DISABLE_AUTOBUILD')} to 1, and fill ${BuildEnv_js_1.OPENCV_PATHS_ENV.map(utils.highlight).join(', ')} environement variables`);
